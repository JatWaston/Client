...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        // Initialization code
        _iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, (self.frame.size.height-30)/2.0f, 30, 30)];
        _iconImageView.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:_iconImageView];
        
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, 0, self.frame.size.width-200, self.frame.size.height)];
        ...
        _descriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(161, 0, self.frame.size.width-250, self.frame.size.height)];
        ...
        _arrowImageView = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width-100, (self.frame.size.height-15)/2.0f, 8, 15)];
