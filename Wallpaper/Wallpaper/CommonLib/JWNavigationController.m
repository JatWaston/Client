...
- (void)viewDidLoad
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 7) {
        ...
        self.navigationBar.titleTextAttributes = @{UITextAttributeTextColor:kNavBarTextColor,
                                                   UITextAttributeFont:kNavBarTextFont,
    ...
    else
    {
        ...
        self.navigationBar.titleTextAttributes = @{UITextAttributeTextColor:kNavBarTextColor, UITextAttributeFont:kNavBarTextFont};
