...
- (void)translucencyStyle
{
    //[self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.5f];
    //self.layer.borderColor = [[UIColor colorWithRed:53/255.0 green:126/255.0 blue:189/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:0.92f green:0.33f blue:0.10f alpha:1.0f]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:0.92f green:0.33f blue:0.10f alpha:1.0f]] forState:UIControlStateSelected];
}
